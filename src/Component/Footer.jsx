...
function Footer() {
  return (
    <div>
      <footer class="bg-[#282c34] antialiased">
        <div class="mx-auto px-16 py-8">
          <div class="mx-auto max-w-2xl">
            <h1 class="mb-6 text-center text-4xl font-bold text-white">
              Lets. Learn. React.
            </h1>
            <p class="mb-8 text-center text-sm font-normal leading-6 text-white/80">
          ...
          <hr class="mt-10 md:mx-10 sm:mx-6 bg-white opacity-[0.25]" />
          <div class="mt-4 grid w-full grid-cols-1 gap-8 sm:grid-cols-3">
            ...
            <div class="flex items-center justify-center">
              <ul class="flex items-center justify-center gap-x-4">
                <li class="flex h-12 w-12 items-center justify-center rounded-full border border-gray-300 hover:bg-blue-800">
